...
function getFlatObject(person) {
  let sundayMorning = {}
  sundayMorning.first = person.names.first
  sundayMorning.middle = person.names.middle
  sundayMorning.last = person.names.last
  sundayMorning.street =person.address.street
  sundayMorning.unit = person.address.unit
  sundayMorning.city = person.address.city
  sundayMorning.state = person.address.state
  sundayMorning.zip = person.address.zip
  sundayMorning.numbers = person.numbers
